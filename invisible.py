...
cv2.createTrackbar("LH", "Tuning", 65, 255, nothing)
cv2.createTrackbar("LS", "Tuning", 123, 255, nothing)
cv2.createTrackbar("LV", "Tuning", 0, 255, nothing)
cv2.createTrackbar("UH", "Tuning", 255, 255, nothing)
